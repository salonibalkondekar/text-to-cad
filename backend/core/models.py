...
class PromptRequest(BaseModel):
    ...
    prompt: str = Field(..., min_length=1, description="Natural language description of the 3D model")
...
class GenerateResponse(BaseModel):
    ...
    generation_status: Optional[GenerationStatus] = Field(None, description="How the model was generated")
...
class UserInfoResponse(BaseModel):
    ...
    user_id: str = Field(..., description="Unique identifier for the user")
    model_count: int = Field(..., ge=0, description="Number of models generated by the user")
...
class UserData(BaseModel):
    ...
    prompts: List[UserPrompt] = Field(default_factory=list, description="All prompts from this user")
    model_count: int = Field(default=0, ge=0, description="Number of models generated")
    created_at: datetime = Field(default_factory=datetime.now, description="When the user was first seen")
