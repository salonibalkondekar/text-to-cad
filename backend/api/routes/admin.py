...
async def delete_user(user_id: str, admin_verified: bool = Depends(verify_admin_access)):
    """
...
async def reset_user_count(user_id: str, admin_verified: bool = Depends(verify_admin_access)):
    """
